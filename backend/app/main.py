...
# Import routers
from app.api.routes import prediction, analysis, comparison, history
from app.api.routes.news import router as news_router
from app.api.routes import prediction_weather
...
app.include_router(prediction_weather.router, prefix="/api/v1", tags=["weather-predictions"])
